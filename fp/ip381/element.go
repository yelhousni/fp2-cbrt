...
func init() {
	_modulus.SetString("1b4fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16)
}
...
func (z *Element) SetInterface(i1 interface{}) (*Element, error) {
	if i1 == nil {
		return nil, errors.New("can't set ip381.Element with <nil>")
	}
	...
	default:
		return nil, errors.New("can't set ip381.Element from type " + reflect.TypeOf(i1).String())
	}
}
...
func (z *Element) IsOne() bool {
	return ((z[5] ^ 734086739261390848) | z[4] | z[3] | z[2] | z[1] | (z[0] ^ 9)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	_, b = bits.Sub64(_z[5], 984036518580453376, b)
...
func (z *Element) SetBytesCanonical(e []byte) error {
	if len(e) != Bytes {
		return errors.New("invalid ip381.Element encoding")
	}
	v, err := BigEndian.Element((*[Bytes]byte)(e))
	if err != nil {
		return err
...
var errInvalidEncoding = errors.New("invalid ip381.Element encoding")
...
const (
	inversionCorrectionFactorWord0 = 8718297676735170529
	inversionCorrectionFactorWord1 = 6213825543938139967
	inversionCorrectionFactorWord2 = 5113352579023564949
	inversionCorrectionFactorWord3 = 18199674133087715040
	inversionCorrectionFactorWord4 = 14162414014446982034
	inversionCorrectionFactorWord5 = 1291950073628393446
	invIterationsN                 = 26
)
