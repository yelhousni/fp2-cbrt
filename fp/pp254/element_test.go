...
func TestElementFixedExp(t *testing.T) {
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("1cad37f83998aac363bdca7f1d562166de85947c17f794799ee3e13cf2112dd", 16)

	properties.Property("ExpByCbrtQPlus8Div27 must match Exp", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrtQPlus8Div27(c)
