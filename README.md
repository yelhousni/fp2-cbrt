...
| `cbrtOkeyaSakurai` | Okeya–Sakurai-style recovery with Hamburg's trick (Scott §2): merges the U⁻¹ inversion into the cube-root exponentiation so that cbrt(n), 1/n and 1/U come from a single exponentiation + a few extra multiplications. |
